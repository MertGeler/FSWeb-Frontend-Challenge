...
export default function MyHeader() {
  ...
  const gitHubOnClickHandler = () => {
    ...
    setTimeout(() => {
      window.open("https://github.com/MertGeler", "_blank");
    }, 2000);
  };
  const linkedInHandler = () => {
    ...
    setTimeout(() => {
      window.open(
        "https://www.linkedin.com/in/fahrettin-mert-geler-332a9b245/",
        "_blank"
      );
    }, 2000);
  };
    ...
    <>
      <div className="header flex">
        <div className="header-left bg-purple dark:bg-[#171043] min-w-[70%]">
          ...
          >
            <span className="text-green">{data[language].header.to}</span>{" "}
        ...
        <div className="header-right bg-green dark:bg-[#1A210B] min-w-[30%]">
          <div className="bg-green dark:bg-[#1A210B]">
            {darkMode ? (
              <div
                className="flex flex-row gap-2 items-center mt-8 ml-8 cursor-pointer"
                id="DarkModeRoot"
              >
                <div
                ...
                <div
                  onClick={darkModeHandler}
                  className="text-xl font-['Inter']tracking-[1.5] text-[#d9d9d9]"
                >
                  LIGHT MODE
                </div>
              </div>
              ...
              >
                ...
                <div
                  onClick={darkModeHandler}
                  className="font-['Inter'] tracking-[1.5] text-[#4731d3] text-xl "
                >
                  DARK MODE
                </div>
              </div>
      ...
      <div className="hero-content flex">
        <div className="hero-left bg-purple dark:bg-[#171043] min-w-[70%] self-end ">
          ...
          <div className="buttons gap-4 flex ml-60 mb-24 mt-8 pt-5">
            ...
            >
              <img
                src={darkMode ? githubDark : githubLigth}
                alt="github-light"
              ></img>
